...
pub async fn prepare_selection(token_n: Option<String>, token_t: Option<String>, id: u32, traitement: TraitementNumerologie) -> Result<String, Box<dyn std::error::Error>> {
